                ...
                <div className=" xl:w-1/2 relative pb-1 h-full lg:pb-0">
                  <div className="relative">
                    <div className="absolute">
                      ...
                      <Link to="/library">
                        <button className="sm:w-full lg:w-auto my-1 border rounded md py-3 px-6 text-center bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">
                          Buat Kategori
                        </button>
                      </Link>
                    </div>
